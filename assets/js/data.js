...
export const gameData = {
    ...
    doctrines: {
        air_superiority: { name: "Superioridade Aérea", description: "Foco em caças de alta performance para dominar os céus.", cost_modifier: 1.15, performance_bonus: { speed: 1.05, maneuverability: 1.10, rate_of_climb: 1.05 }, reliability_modifier: 0.95 },
        strategic_bombing: { name: "Bombardeio Estratégico", description: "Doutrina centrada em bombardeiros pesados de longo alcance.", cost_modifier: 1.20, performance_bonus: { range: 1.20, service_ceiling: 1.10 }, maneuverability_penalty: 0.85 },
        ground_support: { name: "Apoio Tático", description: "Uso de aeronaves para atacar alvos no campo de batalha.", cost_modifier: 1.0, reliability_modifier: 1.10, armor_effectiveness_modifier: 1.10, speed_penalty: 0.90 },
        fleet_defense: { name: "Defesa de Frota", description: "Caças e bombardeiros baseados em porta-aviões.", cost_modifier: 1.25, reliability_modifier: 1.05, performance_bonus: { range: 1.10 }, weight_penalty: 1.05 }
    },
    components: {
        aircraft_types: {
            light_fighter: { 
                ...
                description: "Ágil e rápido, ideal para dogfights.",
                stress_per_g: 15, stress_per_speed_kmh: 0.08, base_cg: 0,
                payload_stations: [
                    { id: 'fuselage_gun', name: 'Fuselagem (Canhão)', max_weight_kg: 200, max_units: 2, cg_position: -0.5, allowed_types: ['gun'] },
            ...
            heavy_fighter: { 
                ...
                payload_stations: [
                    { id: 'nose_guns', name: 'Nariz (Canhões)', max_weight_kg: 400, max_units: 4, cg_position: -1, allowed_types: ['gun'] },
                    { id: 'wing_guns', name: 'Asas (Canhões)', max_weight_kg: 250, max_units: 4, cg_position: -0.3, allowed_types: ['gun'] },
            ...
            cas: { 
                ...
                stress_per_g: 25, stress_per_speed_kmh: 0.06, base_cg: 0.2,
                 payload_stations: [
                    { id: 'centerline_cannon', name: 'Canhão Central', max_weight_kg: 700, max_units: 2, cg_position: -0.2, allowed_types: ['gun'] },
            ...
            tactical_bomber: { 
                ...
                description: "Velocidade e alcance para atacar alvos táticos.",
                stress_per_g: 30, stress_per_speed_kmh: 0.05, base_cg: 0.3,
                payload_stations: [
                    { id: 'bomb_bay', name: 'Baía de Bombas', max_weight_kg: 2000, max_units: 16, cg_position: 0, allowed_types: ['bomb'] },
            ...
            strategic_bomber: { 
                ...
                payload_stations: [
                    { id: 'fwd_bomb_bay', name: 'Baía de Bombas (Frente)', max_weight_kg: 4000, max_units: 20, cg_position: -0.2, allowed_types: ['bomb'] },
                    { id: 'aft_bomb_bay', name: 'Baía de Bombas (Atrás)', max_weight_kg: 4000, max_units: 20, cg_position: 0.8, allowed_types: ['bomb'] }
                ]
            },
        },
        structure_materials: {
            wood_fabric: { name: "Madeira e Tecido", cost_mod: 0.7, weight_mod: 0.8, reliability_mod: 0.9, armor_mod: 0.7, tech_level_required: 0, description: "Leve e barato, mas frágil.", structural_stress_limit: 80 },
            wood_metal: { name: "Madeira e Metal", cost_mod: 1.0, weight_mod: 1.0, reliability_mod: 1.0, armor_mod: 1.0, tech_level_required: 30, description: "Bom equilíbrio entre custo e durabilidade.", structural_stress_limit: 100 },
            ...
            duralumin: { name: "Duralumínio (Monocoque)", cost_mod: 1.6, weight_mod: 1.05, reliability_mod: 1.1, armor_mod: 1.3, tech_level_required: 70, description: "Leve, forte e aerodinâmico.", structural_stress_limit: 200 },
        },
        wing_types: {
            biplane: { name: "Biplane", cost_mod: 1.0, weight_mod: 1.1, drag_mod: 1.2, cl_max_mod: 1.1, cd_0_mod: 1.05, aspect_ratio_mod: 0.8, maneuverability_mod: 1.1, reliability_mod: 1.05, tech_level_required: 0, description: "Boa sustentação, mas alto arrasto." },
        ...
        wing_shapes: {
            elliptical: { name: "Elliptical Wing", description: "Excelente eficiência, mas complexa de fabricar.", turn_mod: 1.1, drag_mod: 0.92, cost_mod: 1.3, svg_url: "https://upload.wikimedia.org/wikipedia/commons/6/62/Wing_elliptical.svg", tech_level_required: 70 },
            tapered: { name: "Tapered Wing", description: "Bom equilíbrio de performance e custo.", turn_mod: 1.05, drag_mod: 0.95, cost_mod: 1.1, svg_url: "https://upload.wikimedia.org/wikipedia/commons/8/87/Wing_tapered.svg", tech_level_required: 50 },
            ...
            gull_wing: { name: "Gull Wing", description: "Permite trem de pouso mais curto e hélice maior.", turn_mod: 0.9, stability_mod: 1.05, landing_gear_weight_mod: 0.85, svg_url: "https://upload.wikimedia.org/wikipedia/commons/f/f6/Monoplane_gull.svg", tech_level_required: 40 },
            inverted_gull: { name: "Inverted Gull Wing", description: "Permite hélice maior e melhor visibilidade.", turn_mod: 1.02, propeller_clearance_bonus: true, svg_url: "https://upload.wikimedia.org/wikipedia/commons/3/30/Monoplane_inverted_gull.svg", tech_level_required: 60 }
        },
        wing_features: {
            ...
            folding_wings: { name: "Asas Dobráveis (Naval)", cost: 12000, weight: 150, metal_cost: 100, reliability_mod: 0.95, tech_level_required: 30 },
        },
        landing_gear_types: {
            fixed_gear: { name: "Fixo", cost: 0, weight: 0, drag_mod: 1.1, reliability_mod: 1.0, tech_level_required: 0 },
            retractable_gear: { name: "Retrátil", cost: 22500, weight: 150, metal_cost: 300, drag_mod: 1.0, reliability_mod: 0.97, tech_level_required: 50 },
        ...
        engineTypes: {
            radial: { name: "Motor Radial", description: "Cilindros em estrela. Confiável e poderoso.", characteristics: { reliability_bonus: 1.20, drag_penalty: 1.15, bsfc_g_per_kwh: 310 }, tech_level_required: 30, cost: 25000, weight: 500, metal_cost: 2000, best_for: "💪 Robusto e resistente a danos" },
            v_inline: { name: "Motor em V / Em Linha", description: "Aerodinâmico e eficiente.", characteristics: { max_speed_bonus: 1.12, drag_reduction: 0.85, reliability_penalty: 0.85, bsfc_g_per_kwh: 290 }, tech_level_required: 50, cost: 35000, weight: 600, metal_cost: 2500, best_for: "⚡️ Alta velocidade e performance em altitude" }
        },
        propellers: {
            ...
            adjustable: { name: "Passo Variável", cost: 15000, weight: 120, metal_cost: 500, efficiency: 0.95, reliability_mod: 0.90, tech_level_required: 70 }
        },
        cooling_systems: {
        ...
        superchargerTypes: {
            none: { name: "Aspiração Natural", description: "Simples e confiável, mas perde potência com altitude.", characteristics: { speed_range: { min: 250, max: 450 }, rated_altitude_m: 0, manifold_pressure_ata: 1.0, power_modifier: 1.0, reliability_bonus: 1.15 }, tech_level_required: 0, best_for: "📉 Baixa altitude, economia", cost: 0, weight: 0 },
            single_stage_single_speed: { name: "Supercharger 1 Estágio/1 Vel.", description: "Básico, otimizado para uma altitude.", characteristics: { speed_range: { min: 350, max: 550 }, rated_altitude_m: 4000, manifold_pressure_ata: 1.3, power_modifier: 1.15 }, tech_level_required: 40, best_for: " altitude média", cost: 8000, weight: 50 },
            single_stage_two_speed: { name: "Supercharger 1 Estágio/2 Vel.", description: "Versátil para baixa e alta altitude.", characteristics: { speed_range: { min: 380, max: 620 }, rated_altitude_m: 6500, manifold_pressure_ata: 1.4, power_modifier: 1.20 }, tech_level_required: 60, best_for: "✈️ Caças versáteis", cost: 15000, weight: 70 },
            two_stage_two_speed: { name: "Supercharger 2 Estágios/2 Vel.", description: "Complexo para alta altitude.", characteristics: { speed_range: { min: 400, max: 700 }, rated_altitude_m: 9000, manifold_pressure_ata: 1.6, power_modifier: 1.30 }, tech_level_required: 70, best_for: "🏔️ Interceptadores", cost: 20000, weight: 90 },
            turbocharger: { name: "Turbocompressor", description: "Mantém potência em altitudes extremas.", characteristics: { speed_range: { min: 420, max: 750 }, rated_altitude_m: 12000, manifold_pressure_ata: 1.8, power_modifier: 1.35 }, tech_level_required: 80, best_for: " stratosphere", cost: 30000, weight: 150 }
        },
        engine_enhancements: {
        ...
        armaments: {
            ...
            cannon_at_40: { name: "Canhão A-T 40mm", cost: 75000, weight: 650, metal_cost: 1500, tech_level_required: 85, type: 'gun', cg_impact: 0.5 },
            ...
            incendiary: { name: "Bomba Incendiária", cost: 5000, weight: 75, metal_cost: 150, tech_level_required: 40, type: 'bomb', cg_impact: 0.08 },
        ...
        defensive_armaments: {
            ...
            defensive_cannon_20: { name: "Canhão 20mm (Def)", cost: 15000, weight: 100, metal_cost: 400, tech_level_required: 50 },
        },
        protection: {
        ...
        advanced_avionics: {
            radio_direction_finder: { name: "Rádio Direção (RDF)", cost: 10000, weight: 25, metal_cost: 80, tech_level_required: 30 },
            ...
            nav_instruments: { name: "Instrumentos de Navegação", cost: 15000, weight: 50, metal_cost: 100, tech_level_required: 40 },
            gyro_compass: { name: "Bússola Giroscópica", cost: 30000, weight: 80, metal_cost: 150, tech_level_required: 60 },
            basic_bomb_sight: { name: "Mira de Bombardeio (Básica)", cost: 7000, weight: 15, metal_cost: 60, tech_level_required: 20 },
            ...
            camera_equipment: { name: "Equipamento de Câmera", cost: 12000, weight: 60, metal_cost: 90, tech_level_required: 30 },
        ...
        equipment: {
            ...
            radio_hf: { name: "Rádio HF", cost: 22500, weight: 100, metal_cost: 200, tech_level_required: 30 },
            ...
            sirens: { name: "Sirenes Psicológicas", cost: 2000, weight: 10, metal_cost: 20, tech_level_required: 0 },
            ...
            drop_tanks: { name: "Tanques Descartáveis", cost: 12000, weight: 20, metal_cost: 200, range_mod: 1.8, reliability_mod: 0.95, tech_level_required: 60 },
            ...
            smoke_generators: { name: "Geradores de Fumaça", cost: 3000, weight: 50, metal_cost: 30, tech_level_required: 0 },
            structural_reinforcement: { name: "Reforços Estruturais", cost: 25000, weight: 300, metal_cost: 500, reliability_mod: 1.02, maneuverability_mod: 0.9 }
        }
    },
    constants: {
